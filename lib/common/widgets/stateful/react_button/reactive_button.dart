...
import 'package:flutter_social_app/common/widgets/stateful/react_button/reactive_button_bloc.dart';
import 'package:flutter_social_app/common/widgets/stateful/react_button/reactive_icon_container.dart';
import 'package:flutter_social_app/common/widgets/stateful/react_button/reactive_icon_definition.dart';
import 'package:flutter_social_app/common/widgets/stateful/react_button/reactive_icon_selection.dart';
import 'package:flutter_social_app/common/widgets/stateful/react_button/widget_position.dart';
...
class _ReactiveButtonState extends State<ReactiveButton> {
  late final ReactiveButtonBloc bloc;
  OverlayState? _overlayState;
  OverlayEntry? _overlayEntry;
  OverlayEntry? _transparentLayer;
  ...
  void _startTimer() {
    _cancelTimer();
    timer = Timer(const Duration(milliseconds: 200), _showIcons);
  }
  ...
  void _showIcons() {
    ...
    _transparentLayer = OverlayEntry(
      builder: (context) {
        return GestureDetector(
          onTap: () {
            _hideIcons();
    ...
    _overlayState!
      ..insert(_transparentLayer!)
      ..insert(_overlayEntry!);
  }

  void _hideIcons() {
    _transparentLayer?.remove();
    _transparentLayer = null;
  ...
  Offset _getIconsContainerPosition() {
    ...
    if (widgetPosition.xPositionInViewport! >
        widgetPosition.viewportWidth! / 2) {
      left = (widgetPosition.xPositionInViewport! +
              widgetPosition.rect!.width -
              containerWidth)
          .clamp(0.0, double.infinity);
    } else {
      left = widgetPosition.xPositionInViewport! - 70.0;
    ...
    if (widget.containerAbove) {
      ...
      final roomBelow = widgetPosition.viewportHeight! -
